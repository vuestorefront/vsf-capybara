          ...
          >
            <div class="start-md">
              ...
              <div class="mt15">
                <router-link
                  class="cl-secondary"
                  :to="localizedRoute('/women/women-20')"
                  exact
                >
                  {{ $t("Women fashion") }}
                </router-link>
            ...
            <div class="start-md">
              ...
              <div class="mt15">
                ...
                <router-link
                  class="cl-secondary"
                  :to="localizedRoute('/custom-cms-page')"
                  exact
                >
                  {{ $t("Custom Cms Page") }}
                </router-link>
              ...
              <div class="mt15">
                ...
                <router-link
                  class="cl-secondary"
                  :to="localizedRoute('/cms-page-sync')"
                  exact
                >
                  {{ $t("Cms Page Sync") }}
                </router-link>
