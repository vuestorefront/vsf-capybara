<template>
  <div class="mb35">
    ...
    <!-- My orders body -->
    <div class="row">
      <div v-show="!isHistoryEmpty" class="col-xs-12">
            ...
            >
              ...
              <td class="fs-medium lh25">
                <span class="relative dropdown">
                  ...
                  <div
                    class="dropdown-content bg-cl-primary align-left sans-serif lh20 weight-400 fs-medium-small py5"
                  >
                    <router-link
                      class="no-underline block py10 px15"
                      :to="
                        localizedRoute(`/my-account/orders/${order.entity_id}`)
                      "
                    >
                      {{ $t("View order") }}
                    </router-link>
      ...
      <div v-show="isHistoryEmpty" class="col-xs-12 h4">
        <p>{{ $t("No orders yet") }}</p>
      </div>
    </div>
  </div>
