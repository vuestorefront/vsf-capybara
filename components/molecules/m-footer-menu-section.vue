<template>
  ...
  >
    <SfFooterColumn
      v-for="footerColumn in columns"
      :key="footerColumn.title"
      :title="footerColumn.title"
    >
      <SfList v-if="footerColumn.items">
        <SfListItem v-for="item in footerColumn.items" :key="item">
      ...
      columns: [
        ...
        },
        {
          ...
          items: [ 'FAQ',
            ...
            'Le réseau de Garantie SWAP Europe'
          ]
        }
      ],
      column: 4,
